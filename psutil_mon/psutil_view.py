...
def system_view_brief(client, title = ''):
	...
	loader_list.append(common.core.loader(os.path.join(client, loader_file), cpu_filter, loader_file.replace(".rrd", "")))

	loader_file =common.core.get_data_of_client(client, 'psutil_'+'memory')
	loader_list.append(common.core.loader(os.path.join(client, loader_file), mem_filter, loader_file.replace(".rrd", "")))

	loader_file =common.core.get_data_of_client(client, 'psutil_'+'swap')
	loader_list.append(common.core.loader(os.path.join(client, loader_file), swap_filter, loader_file.replace(".rrd","")))

	loader_file =common.core.get_data_of_client(client, 'psutil_'+'disk')
	loader_list.append(common.core.loader(os.path.join(client, loader_file), disk_filter, loader_file.replace(".rrd","")))

	loader_file =common.core.get_data_of_client(client, 'psutil_'+'net')
	loader_list.append(common.core.loader(os.path.join(client, loader_file), net_filter, loader_file.replace(".rrd","")))

	loader_file =common.core.get_data_of_client(client, 'psutil_'+'resource')
	loader_list.append(common.core.loader(os.path.join(client, loader_file), resource_filter, loader_file.replace(".rrd","")))
...
def system_view(client, item, title = ''):
	...
	for loader_file in loader_file_list:
		print(loader_file)
		loader_list.append(common.core.loader(os.path.join(client, loader_file), filter, loader_file.replace(".rrd","")))
