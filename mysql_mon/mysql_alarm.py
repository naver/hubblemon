...
class mysql_alarm:
	...
	def get_conf(self, client, instance): # client: machine name, instance: same
		# select exact conf
		abs_conf = self.select_db_conf(client, instance, mysql_mon.settings.alarm_conf_absolute)
		lambda_conf = self.select_db_conf(client, instance, mysql_mon.settings.alarm_conf_lambda)
